...
class CLIPVisionTower(nn.Module):
    ...
    def load_model(self):
        ...
        self.image_processor = CLIPImageProcessor.from_pretrained('../../clip/fine_tuned_clip_processor_4')
        # self.vision_tower = CLIPVisionModel.from_pretrained(self.vision_tower_name)
        self.vision_tower = CLIPVisionModel.from_pretrained('../../clip/fine_tuned_clip_4')
